...
namespace QuotationSystem.Migrations
{
    ...
    [Migration("20250724151600_QuotationCoursePrice")]
    partial class QuotationCoursePrice
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QuotationSystem.Models.QuotationCoursePrice", b =>
                {
                    b.Property<int>("QuotationCoursePriceId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("QuotationCoursePriceId"));
                    ...
                    b.HasKey("QuotationCoursePriceId");

                    b.HasIndex("QuotationCourseId")
                        .IsUnique();

                    b.ToTable("QuotationCoursePrices");
                });
            ...
            modelBuilder.Entity("QuotationSystem.Models.QuotationCoursePrice", b =>
                {
                    b.HasOne("QuotationSystem.Models.QuotationCourse", "QuotationCourse")
                        .WithOne("QuotationCoursePrice")
                        .HasForeignKey("QuotationSystem.Models.QuotationCoursePrice", "QuotationCourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("QuotationCourse");
                });
            ...
            modelBuilder.Entity("QuotationSystem.Models.QuotationCourse", b =>
                {
                    b.Navigation("QuotationCoursePrice")
                        .IsRequired();
                });
